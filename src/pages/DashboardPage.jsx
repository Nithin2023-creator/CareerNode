    ...
    <div className="space-y-10">
      ...
      >
        ...
        <motion.div variants={item} className="bento-card col-span-1 md:col-span-2 lg:col-span-2 row-span-2 group cursor-pointer block p-5 md:p-8 lg:p-10 flex flex-col justify-between bg-white">
          <Link to="/dashboard/job-finder" className="absolute inset-0 z-20" />
        ...
        <motion.div variants={item} className="bento-card bg-white group cursor-pointer p-8 flex flex-col justify-between">
          <Link to="/dashboard/emailer" className="absolute inset-0 z-20" />
          <div className="flex justify-between items-start z-10 relative">
        ...
        {/* Resume Maker */}
        <motion.div variants={item} className="bento-card bg-white group cursor-pointer p-8 flex flex-col justify-between">
          <Link to="/dashboard/resume-maker" className="absolute inset-0 z-20" />
          <div className="flex justify-between items-start z-10 relative">
        ...
        {/* Automations */}
        <motion.div variants={item} className="bento-card bg-white group cursor-pointer p-8 flex flex-col justify-between">
          <Link to="/dashboard/automations" className="absolute inset-0 z-20" />
          <div className="flex justify-between items-start z-10 relative">
        ...
        {/* Membership Status */}
        <motion.div variants={item} className="bento-card bg-white group cursor-pointer p-8 flex flex-col justify-between">
          <Link to="/dashboard/billing" className="absolute inset-0 z-20" />
          <div className="flex justify-between items-start z-10 relative">
