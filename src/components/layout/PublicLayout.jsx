    ...
    <div className="min-h-screen bg-[var(--color-background)] text-black relative">
      ...
      <nav className="fixed top-0 w-full z-50 p-4 md:p-6 lg:px-8 lg:py-6 pointer-events-none">
        <div className="mx-auto flex justify-between items-center pointer-events-auto">
          {/* Logo */}
          <Link to="/" className="bg-white/80 backdrop-blur-md rounded-full px-6 py-3 hover:translate-y-[-2px] transition-all flex items-center gap-1 group shadow-[var(--shadow-soft)]">
            <span className="font-display font-bold text-2xl tracking-tight text-black leading-none uppercase">
              Career
            </span>
            <span className="font-display font-bold text-2xl tracking-tight text-white bg-black px-1.5 rounded-xl leading-none uppercase pt-0.5">
              Node.
            </span>
            <HouseIcon
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="text-sm font-bold tracking-widest uppercase hover:text-[var(--color-accent-blue)] transition-colors hidden sm:block"
            >
              Log in
            </button>
            <Link to="/dashboard" className="bg-black text-white rounded-full px-6 py-3 font-bold text-sm tracking-widest hover:bg-[var(--color-accent-blue)] hover:text-white hover:-translate-y-0.5 transition-all flex items-center gap-2 group shadow-[var(--shadow-soft)]">
